...
setup(
    ...
    keywords='sample setuptools development fabryperot',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    # package_dir={'': 'samfp'},
    packages=['illusion'],
    package_dir={'illusion': 'illusion'},
    package_data={'illusion': [
        'default/*.json',
        'default/*.ini',
        'data/*.fits'
        ]
    },
    scripts=['scripts/illusion'],
    zip_safe=False,
